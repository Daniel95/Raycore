...
public:
    ...
    * returned.
    */
    std::shared_ptr<Window> CreateRenderWindow(const std::wstring& windowName, int clientWidth, int clientHeight, bool vSync = false );
    ...
    */
    int Run(std::shared_ptr<DX12Application> pGame);
...
private:
    ...
    DX12Graphics(const DX12Graphics& copy) = delete;
    DX12Graphics& operator=(const DX12Graphics& other) = delete;
