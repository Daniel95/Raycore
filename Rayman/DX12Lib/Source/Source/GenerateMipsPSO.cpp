...
GenerateMipsPSO::GenerateMipsPSO()
{
    ...
    m_DefaultUAV = DX12Graphics::Get().AllocateDescriptors( D3D12_DESCRIPTOR_HEAP_TYPE_CBV_SRV_UAV, 4 );
    UINT descriptorHandleIncrementSize = DX12Graphics::Get().GetDescriptorHandleIncrementSize( D3D12_DESCRIPTOR_HEAP_TYPE_CBV_SRV_UAV );
